...
import static com.zcolin.frame.utils.NUriParse.getImageContentUri;
import static com.zcolin.frame.utils.NUriParse.getUriFromPath;
...
public class SystemIntentUtil {
    ...
    public static void selectPhotoWithCrop(final Object object, final String savePath, final int cropX,
        ...
        selectPhoto(object, new OnCompleteLisenter() {
            @Override
            public void onSelected(Uri fileProviderUri) {
                SystemIntentUtil.cropPhoto(object, NUriParse.getImageFileFromUri(fileProviderUri), savePath, cropX, cropY, onCompleteLisenter);
            }
    ...
    public interface OnCompleteLisenter {
        /**
         * @param fileProviderUri FileProvider的Uri，如果要获取实际路径需要使用 {@link NUriParse#getFileFromUri(String, Uri)}
         */
